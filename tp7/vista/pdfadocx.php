...
<body class="text-center">
  ...
  <div class="mb-3">
    <label for="archivo" class="form-label fw-semibold">Seleccionar archivo PDF</label>
    <input class="form-control form-control-lg " type="file" id="archivo" name="archivo" accept=".pdf,application/pdf" required>
